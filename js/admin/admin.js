...
$('#kiosk-mgmt').addEventListener('click', ()=>{ window.location.href = 'kiosk/kiosk-management.html'; });
$('#kiosk-terminal').addEventListener('click', ()=>{ window.location.href = 'kiosk/kiosk-login.html'; });
